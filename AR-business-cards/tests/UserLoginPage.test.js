...
//Beacuse firstly, the necessary dependencies are not in package.json on this branch
//Secondly, we had an issue when trying to mock certain hooks such as 'usefont' and thus without that mock, the tests would just fail
//Also, on this branch, the testIDs' haven't been set up in components to test
